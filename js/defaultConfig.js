        ...
        "SCL": {
            ...
            "sopSections": [
                ...
                },
                {
                    ...
                    "title": "Impact Rules",
                    "alwaysShow": true,
                    "content": "\n                <div class=\"bg-blue-900 border border-blue-500 rounded p-2 mb-2 text-sm text-theme-accentsec\">\n                    <strong>Priority Guidance:</strong>\n                    <ul class=\"list-disc pl-5 mt-1\">\n                        <li>Default: PE2 - Onsite within 2 hours.</li>\n                    </ul>\n                </div>\n            "
                },
                {
                    "id": "phase3",
                    "title": "Phase 3 - Outbound Call",
                ...
                {
                    "id": "force-instruction",
                    "title": "Override Instruction",
                    "phase": "phase-1-investigate",
                    "showIf": "suct_psi !== ''",
                    "content": "\n        <div class=\"bg-theme-panel1 p-2 rounded mb-2 border-l-4 border-yellow-500\">\n            <h4 class=\"font-bold text-yellow-400\">Override Procedure:</h4>\n            <p class=\"text-xs text-theme-text\">Take the baseline Suction Setpoint and place a force in EMS +15 PSI higher so it tracks aggressively but safely if isolated.</p>\n            <p class=\"text-xs text-yellow-200 mt-1 font-bold\">You should force it to exactly: <span class=\"bg-yellow-900 text-yellow-100 px-1 rounded\">{parseFloat(data.suct_psi) + thresholds.suction_psi.targetVariance.above} PSI</span></p>\n        </div>"
                }
            ],
            "crystalAttributes": {
                "issueArea": "Home Office Only",
            ...
            "fields": [
                ...
                {
                    "id": "suct_psi",
                    "label": "Suction PSI Setpoint",
                    "type": "text",
                    "phase": "phase-1-investigate"
                },
                {
                    "id": "forced_suct",
                    "label": "Transducer Override",
                    "type": "radio",
                    "options": [
                        "Did not force suct psi",
                        "Forced suct psi to ({parseFloat(data.suct_psi) + thresholds.suction_psi.targetVariance.above})"
                    ],
                    "phase": "phase-1-investigate",
                    "visibleIf": "suct_psi !== ''"
                },
            ...
            "sopSections": [
                {
                    ...
                    "content": "<div class=\"space-y-4 max-w-full text-sm\">\n    <div class=\"bg-theme-panel1 border border-theme-borderdark p-3 rounded shadow-sm\">\n        <h4 class=\"font-bold text-theme-text mb-3 border-b border-theme-borderdark pb-1 text-xs uppercase tracking-wider\">Stale Data Guidance</h4>\n        <p class=\"text-theme-text mb-2\">Stale data occurs when the EMS stops receiving updates from the rack controller.</p>\n        <ul class=\"space-y-2 text-theme-text pl-2\">\n            <li class=\"flex items-start\"><span class=\"text-theme-accentsec mr-2 mt-0.5\">•</span><span>Verify if there is a network outage or if only this controller is offline.</span></li>\n            <li class=\"flex items-start\"><span class=\"text-theme-accentsec mr-2 mt-0.5\">•</span><span>Check for overlapping comm loss alarms.</span></li>\n            <li class=\"flex items-start\"><span class=\"text-orange-500 mr-2 mt-0.5\">•</span><span>Snoozing: Stale data might resolve on network reconnect, but extended loss requires a dispatch.</span></li>\n        </ul>\n    </div>\n</div>",
                    "alwaysShow": true
                },
                {
                    "id": "phase1",
                    "title": "Phase 1 Assessment",
                    "content": "<p class=\"text-sm text-theme-text\">Check affected systems and verify parameters.</p>",
                    "phase": "phase-1-investigate"
                },
                {
                    "id": "phase2",
                    "title": "Phase 2 Rules",
                    "content": "<p class=\"text-sm text-theme-text\">Do not downgrade priority. Check for existing WO.</p>",
                    "phase": "phase-2-dispatch"
                },
                {
                    "id": "phase3",
            ...
            "sopSections": [
                {
                    ...
                    "content": "<div class=\"space-y-4 max-w-full text-sm\">\n    <div class=\"bg-theme-panel1 border border-theme-borderdark p-3 rounded shadow-sm\">\n        <h4 class=\"font-bold text-theme-text mb-3 border-b border-theme-borderdark pb-1 text-xs uppercase tracking-wider\">Rack Fault Guidance</h4>\n        <p class=\"text-theme-text mb-2\">A Rack Fault is a generalized alarm indicating an unhandled problem at the rack level.</p>\n        <ul class=\"space-y-2 text-theme-text pl-2\">\n            <li class=\"flex items-start\"><span class=\"text-theme-accentsec mr-2 mt-0.5\">•</span><span>Investigate the rack's sub-parameters to find the root cause (e.g., oil, temp, etc.).</span></li>\n            <li class=\"flex items-start\"><span class=\"text-orange-500 mr-2 mt-0.5\">•</span><span>Do not snooze unless the fault is identified and actively resolving.</span></li>\n            <li class=\"flex items-start\"><span class=\"text-red-500 mr-2 mt-0.5\">•</span><span>Priority Downgrade: Do not downgrade any WO that generates as PE-2hr or PE-4hr without documented approval.</span></li>\n        </ul>\n    </div>\n</div>",
                    "alwaysShow": true
                },
                {
                    "id": "phase1",
            ...
            "sopSections": [
                {
                    ...
                    "content": "<div class=\"space-y-4 max-w-full text-sm\">\n    <div class=\"bg-theme-panel1 border border-theme-borderdark p-3 rounded shadow-sm\">\n        <h4 class=\"font-bold text-theme-text mb-3 border-b border-theme-borderdark pb-1 text-xs uppercase tracking-wider\">High Discharge Pressure Guidance</h4>\n        <p class=\"text-theme-text mb-2\">High discharge pressure can indicate a condenser issue, fan failure, or high ambient temps.</p>\n        <ul class=\"space-y-2 text-theme-text pl-2\">\n            <li class=\"flex items-start\"><span class=\"text-theme-accentsec mr-2 mt-0.5\">•</span><span>Check condenser fans and ambient temperature.</span></li>\n            <li class=\"flex items-start\"><span class=\"text-red-500 mr-2 mt-0.5\">•</span><span>Dangerous condition: can lead to rack venting refrigerant if not resolved quickly. Emergency dispatch is typical.</span></li>\n            <li class=\"flex items-start\"><span class=\"text-orange-500 mr-2 mt-0.5\">•</span><span>Snoozing: Never snooze a Rack alarm for more than 2 hours.</span></li>\n        </ul>\n    </div>\n</div>",
                    "alwaysShow": true
                },
                {
                    "id": "phase1",
