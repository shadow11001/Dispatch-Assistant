    ...
    "profiles": {
        "DISPATCH": {
            ...
            "sopSections": [
                ...
                {
                    "id": "store-contact",
                    "title": "Contact the Store Manager",
                    "showOnlyOnPhase": "phase-2-store",
                    "content": "\n<h3 class=\"mb-2 text-lg font-bold\">Contact the Store Manager</h3>\n\n<p>Call the Store Manager listed on the work order. Follow the appropriate script based on whether the call is answered.</p>\n\n<div class=\"space-y-3\">\n  <!-- Answered -->\n  <details class=\"rounded-lg border border-green-700 bg-green-900/20\">\n    <summary class=\"cursor-pointer px-4 py-3 font-bold text-green-400\">📞 Store Manager Answers</summary>\n\n    <div class=\"px-4 pb-4\">\n      <p class=\"mb-2\">Read the following script:</p>\n\n      <pre class=\"rounded-lg border border-gray-700 bg-gray-900 p-3 whitespace-pre-wrap\"><code>Hello, my name is [Your Name], calling from Upstream Facility Services regarding emergency {trade} Work Order {dispatch_ref} for your store.\n\nThe work order has escalated due to additional alarms. We are working to get a technician onsite as soon as possible.\n\nDo you have any questions for me at this time?</code></pre>\n\n      <div class=\"mt-4\">\n        <strong>If the Store Manager has questions:</strong>\n        <p>Answer them to the best of your ability.</p>\n      </div>\n\n      <div class=\"mt-3\">\n        <strong>If the Store Manager has no questions:</strong>\n\n        <pre class=\"mt-2 rounded-lg border border-gray-700 bg-gray-900 p-3 whitespace-pre-wrap\"><code>Thank you so much for your time today. Please monitor product and follow failure guidelines found on OneWalmart/The WIRE. Have a great day.</code></pre>\n      </div>\n    </div>\n  </details>\n\n  <!-- Voicemail -->\n  <details class=\"rounded-lg border border-yellow-700 bg-yellow-900/20\">\n    <summary class=\"cursor-pointer px-4 py-3 font-bold text-yellow-400\">📬 Store Manager Does Not Answer (Voicemail)</summary>\n\n    <div class=\"px-4 pb-4\">\n      <p class=\"mb-2\">Leave the following voicemail:</p>\n\n      <pre class=\"rounded-lg border border-gray-700 bg-gray-900 p-3 whitespace-pre-wrap\"><code>Hello, this is [Your Name] calling regarding emergency {trade} Work Order {dispatch_ref} for Store {store_number}.\n\nThe work order has escalated due to additional alarms.\n\nPlease monitor product in the affected assets and follow Food Safety Guidelines as found on OneWalmart/The WIRE.\n\nThis message is being documented in the work order.</code></pre>\n    </div>\n  </details>\n</div>\n\n<!-- Voicemail Warning -->\n<div class=\"rounded border-l-4 border-red-500 bg-red-900/20 p-3 mt-4\">\n  <h4 class=\"font-bold text-red-400\">Required After Leaving a Voicemail</h4>\n\n  <ul class=\"mt-2 ml-5 list-disc space-y-1\">\n    <li>Create a new Work Order note.</li>\n    <li>Check <strong>Action Required</strong>.</li>\n    <li>Check <strong>Send a Copy to Myself</strong>.</li>\n    <li>Email the following recipients:</li>\n  </ul>\n\n  <pre class=\"mt-3 rounded-lg border border-gray-700 bg-gray-900 p-3\"><code>store-mgr.s{store_number}@stores.us.wal-mart.com;\nauto-care-center-manager.s{store_number}@stores.us.wal-mart.com</code></pre>\n</div>\n\n<!-- Voicemail WorkOrder Template -->\n<div class=\"mt-4 mb-2 flex items-center justify-between\">\n    <h4 class=\"font-bold text-blue-400\">Store Contact Note Template</h4>\n\n    <button class=\"rounded bg-blue-600 px-2 py-1 text-xs hover:bg-blue-700\"\n        onclick=\"navigator.clipboard.writeText('Reference#: {dispatch_ref} | Called {store_mgr_name} about emergency {trade} Work Order {dispatch_ref}. Result: {store_answ}. The store was told about the work order and the correct safety, store, or product steps.')\">\n        Copy\n    </button>\n</div>\n\n<pre class=\"rounded-lg border border-gray-700 bg-gray-900 p-3 whitespace-pre-wrap\"><code>Reference#: {dispatch_ref} | Called {store_mgr_name} about emergency {trade} Work Order {dispatch_ref}. Result: {store_answ}. The store was told about the work order and the correct safety, store, or product steps.</code></pre>\n"
                },
                {
                    "id": "tech-contact-1",
                    "title": "Contact the Assigned Technician - Attempt 1",
                    "showOnlyOnPhase": "phase-3-tech1",
                    "content": "\n<div class=\"rounded border-l-4 border-blue-500 bg-blue-900/20 p-3 mb-4\">\n  <h3 class=\"mb-2 font-bold text-blue-400\">Step 3 - Contact the Assigned Technician</h3>\n\n  <p>Call the assigned technician or vendor regarding the emergency work order.</p>\n\n  <ul class=\"mt-2 ml-5 list-disc space-y-1\">\n    <li>Explain the emergency.</li>\n    <li>Verify they can meet the required SLA.</li>\n    <li>Answer any questions.</li>\n    <li>Determine the outcome of the call.</li>\n  </ul>\n</div>\n\n<h3 class=\"font-bold text-green-400 mb-2\">\nTechnician Call Script\n</h3>\n\n<pre class=\"bg-gray-900 border border-gray-700 rounded-lg p-3 whitespace-pre-wrap\"><code>Hello, this is [Your Name] from Upstream Facility Services calling regarding emergency {trade} Work Order {dispatch_ref} for Store {store_number}.\n\nThis is a {priority} alarm. The affected assets listed in ServiceChannel are:\n\n{assets}\n\nAre you able to complete this work order within the required SLA?</code></pre>\n\n<div class=\"rounded border-l-4 border-yellow-500 bg-yellow-900/20 p-3 mt-4\">\n  <h3 class=\"font-bold text-yellow-400\">Technician Voicemail - Attempt #1</h3>\n\n  <p>Leave the following voicemail if no answer.</p>\n\n  <pre class=\"rounded-lg border border-gray-700 bg-gray-900 p-3 whitespace-pre-wrap\"><code>Hello, this is [Your Name] from Upstream Facility Services calling regarding emergency {trade} Work Order {dispatch_ref} for Store {store_number}.\n\nThe affected assets listed in ServiceChannel are:\n\n{assets}\n\nWe will attempt to call back in the next 5 minutes for a second attempt.</code></pre>\n</div>\n\n<div class=\"mt-4 mb-2 flex items-center justify-between\">\n    <h4 class=\"font-bold text-blue-400\">Oracle & ServiceChannel Note</h4>\n\n    <button class=\"rounded bg-blue-600 px-2 py-1 text-xs hover:bg-blue-700\"\n        onclick=\"navigator.clipboard.writeText('Call #1 | Called assigned tech {tech_name} about emergency {trade} Work Order {dispatch_ref}. Result: {tech1_answ}. Notes were added to Oracle and ServiceChannel.')\">\n        Copy\n    </button>\n</div>\n\n<pre class=\"rounded-lg border border-gray-700 bg-gray-900 p-3\"><code>Call #1 | Called assigned tech {tech_name} about emergency {trade} Work Order {dispatch_ref}. Result: {tech1_answ}. Notes were added to Oracle and ServiceChannel.</code></pre>\n"
                },
                {
                    "id": "tech-5min",
                    "title": "Wait 5 Minutes",
                    "showOnlyOnPhase": "phase-4-wait5",
                    "content": "\n<div class=\"rounded border-l-4 border-indigo-500 bg-indigo-900/20 p-3\">\n  <h3 class=\"font-bold text-indigo-400\">Wait 5 Minutes</h3>\n\n  <p>Wait 5 minutes before proceeding to Attempt 2. Ensure ServiceChannel is active.</p>\n</div>\n"
                },
                {
                    "id": "tech-15min",
                    "title": "Wait 15 Minutes for Acceptance",
                    "showOnlyOnPhase": "phase-5-wait15",
                    "content": "\n<div class=\"rounded border-l-4 border-indigo-500 bg-indigo-900/20 p-3\">\n  <h3 class=\"font-bold text-indigo-400\">Wait 15 Minutes</h3>\n\n  <p>Wait 15 minutes while periodically refreshing ServiceChannel to check whether the technician has accepted the work order.</p>\n\n  <div class=\"mt-2 mb-2 flex items-center justify-between\">\n    <h4 class=\"font-bold text-green-400\">Oracle Note (When Accepted)</h4>\n\n    <button class=\"rounded bg-blue-600 px-2 py-1 text-xs hover:bg-blue-700\"\n        onclick=\"navigator.clipboard.writeText('Technician has accepted Work Order | Closing Oracle Ticket as Resolved')\">\n        Copy\n    </button>\n  </div>\n  <pre class=\"rounded-lg border border-gray-700 bg-gray-900 p-3\"><code>Technician has accepted Work Order | Closing Oracle Ticket as Resolved</code></pre>\n</div>\n"
                },
                {
                    "id": "tech-contact-2",
                    "title": "Contact the Assigned Technician - Attempt 2",
                    "showOnlyOnPhase": "phase-6-tech2",
                    "content": "\n<h3 class=\"font-bold text-green-400 mb-2\">\nTechnician Call Script - Attempt 2\n</h3>\n\n<pre class=\"bg-gray-900 border border-gray-700 rounded-lg p-3 whitespace-pre-wrap\"><code>Hello, this is [Your Name] from Upstream Facility Services calling regarding emergency {trade} Work Order {dispatch_ref} for Store {store_number}.\n\nWe reached out recently regarding acceptance of this work order.\n\nCan you complete this work within the required SLA?</code></pre>\n\n<div class=\"rounded border-l-4 border-yellow-500 bg-yellow-900/20 p-3 mt-4\">\n  <h3 class=\"mb-2 font-bold text-yellow-400\">Technician Voicemail - Attempt #2</h3>\n\n  <p>Leave the following voicemail.</p>\n\n  <pre class=\"rounded-lg border border-gray-700 bg-gray-900 p-3 whitespace-pre-wrap\"><code>Hello, this is [Your Name] from Upstream Facility Services calling regarding emergency {trade} Work Order {dispatch_ref} for Store {store_number}.\n\nWe reached out recently regarding acceptance of this work order.\n\nIf you are able, please accept the work order within the next 15 minutes or contact your Field Support Manager for reassignment.</code></pre>\n</div>\n\n<div class=\"mt-4 mb-2 flex items-center justify-between\">\n    <h4 class=\"font-bold text-yellow-400\">Oracle & ServiceChannel Note</h4>\n\n    <button class=\"rounded bg-blue-600 px-2 py-1 text-xs hover:bg-blue-700\"\n        onclick=\"navigator.clipboard.writeText('Call #2 | Called assigned tech {tech_name} about emergency {trade} Work Order {dispatch_ref}. Result: {tech2_answ}. Notes were added to Oracle and ServiceChannel.')\">\n        Copy\n    </button>\n</div>\n\n<pre class=\"rounded-lg border border-gray-700 bg-gray-900 p-3\"><code>Call #2 | Called assigned tech {tech_name} about emergency {trade} Work Order {dispatch_ref}. Result: {tech2_answ}. Notes were added to Oracle and ServiceChannel.</code></pre>\n"
                },
                {
                    "id": "fs-manager",
                    "title": "Contact the FS Manager",
                    "showOnlyOnPhase": "phase-7-fs",
                    "content": "\n<div class=\"rounded border-l-4 border-blue-500 bg-blue-900/20 p-3 mb-4\">\n  <h3 class=\"mb-2 font-bold text-blue-400\">Step 4 - Contact the FS Manager</h3>\n\n  <p>Contact the assigned Field Support Manager to request guidance on the emergency work order.</p>\n\n  <div class=\"mt-3 rounded border-l-4 border-yellow-500 bg-yellow-900/20 p-3\">\n    <strong>Important</strong><br />\n    Do <strong>not</strong> call the FS Manager if the work order has already been downgraded, unless circumstances have changed that could quickly lead to product loss.\n  </div>\n</div>\n\n<h3 class=\"mb-2 font-bold text-green-400\">FS Manager Call Script</h3>\n\n<pre class=\"rounded-lg border border-gray-700 bg-gray-900 p-3 whitespace-pre-wrap\"><code>Hello, this is [Your Name] calling from Upstream Facility Services regarding emergency {trade} Work Order {dispatch_ref} for Store {store_number}.\n\nWe completed the required tech calls and need confirmation of next steps for emergency coverage.\n\nThe affected assets listed in ServiceChannel are:\n\n{assets}\n\nPlease advise.</code></pre>\n\n<div class=\"mt-4 mb-2 flex items-center justify-between\">\n    <h4 class=\"font-bold text-blue-400\">Document the Interaction</h4>\n    <button class=\"rounded bg-blue-600 px-2 py-1 text-xs hover:bg-blue-700\"\n        onclick=\"navigator.clipboard.writeText('Called FS Manager {fs_name} about emergency {trade} Work Order {dispatch_ref}. Tech contact result: {tech1_answ} / {tech2_answ}. FS Manager response: {fs_action}. Notes were added to Oracle and ServiceChannel.')\">\n        Copy\n    </button>\n</div>\n\n<pre class=\"rounded-lg border border-gray-700 bg-gray-900 p-3 whitespace-pre-wrap\"><code>Called FS Manager {fs_name} about emergency {trade} Work Order {dispatch_ref}. Tech contact result: {tech1_answ} / {tech2_answ}. FS Manager response: {fs_action}. Notes were added to Oracle and ServiceChannel.</code></pre>\n"
                },
                {
                    "id": "rm-manager",
                    "title": "Contact the Regional Manager",
                    "showOnlyOnPhase": "phase-8-rm",
                    "content": "\n<div class=\"rounded border-l-4 border-blue-500 bg-blue-900/20 p-3 mb-4\">\n  <h3 class=\"mb-2 font-bold text-blue-400\">Step 5 - Regional Manager Contact Needed</h3>\n\n  <p>Contact the Regional Manager for direction when technician assignment has not been secured through the technician or Field Support Manager escalation paths.</p>\n</div>\n\n<h3 class=\"mb-2 font-bold text-green-400\">Regional Manager Call Script</h3>\n\n<pre class=\"rounded-lg border border-gray-700 bg-gray-900 p-3 whitespace-pre-wrap\"><code>Hello, this is [Your Name] calling regarding emergency {trade} Work Order {dispatch_ref} for Store {store_number}.\n\nWe attempted Field Support Management contact and need confirmation of next steps for emergency coverage.\n\nThe affected assets listed in ServiceChannel are:\n\n{assets}\n\nPlease advise.</code></pre>\n\n<div class=\"mt-4 mb-2 flex items-center justify-between\">\n    <h4 class=\"font-bold text-blue-400\">Document the Interaction</h4>\n    <button class=\"rounded bg-blue-600 px-2 py-1 text-xs hover:bg-blue-700\"\n        onclick=\"navigator.clipboard.writeText('Called Regional Manager {rm_name} about emergency {trade} Work Order {dispatch_ref}. Tech and FS Manager contact result: FS did not answer/no change. Regional Manager response: {rm_action}. Notes were added to Oracle and ServiceChannel.')\">\n        Copy\n    </button>\n</div>\n\n<pre class=\"rounded-lg border border-gray-700 bg-gray-900 p-3 whitespace-pre-wrap\"><code>Called Regional Manager {rm_name} about emergency {trade} Work Order {dispatch_ref}. Tech and FS Manager contact result: FS did not answer/no change. Regional Manager response: {rm_action}. Notes were added to Oracle and ServiceChannel.</code></pre>\n"
                },
                {
                    "id": "vendor",
                    "title": "Vendor Assignment",
                    "showOnlyOnPhase": "phase-9-vendor",
                    "content": "\n<div class=\"rounded border-l-4 border-red-500 bg-red-900/20 p-3\">\n  <h3 class=\"font-bold text-red-400\">Final Escalation Path - Begin Vendor Assignment</h3>\n\n  <p>When leadership has not provided an assignment, begin working through the eligible vendor ranking list.</p>\n</div>\n<h4 class=\"font-bold text-yellow-400 mt-4\">Vendor Eligibility Requirements</h4>\n\n<ul class=\"ml-5 list-disc mb-4\">\n  <li>Vendor ranking must be below 50.</li>\n  <li>Do not assign Walmart HVAC.</li>\n  <li>Do not assign Walmart Insource.</li>\n  <li>Assign one vendor at a time in ranking order.</li>\n</ul>\n\n<div class=\"mt-4 mb-2 flex items-center justify-between\">\n    <h4 class=\"font-bold text-blue-400\">Vendor Assignment Note</h4>\n    <button class=\"rounded bg-blue-600 px-2 py-1 text-xs hover:bg-blue-700\"\n        onclick=\"navigator.clipboard.writeText('Reference {dispatch_ref} | Assigned emergency {trade} Work Order {dispatch_ref} to vendor {vendor_name}, Rank {vendor_rank}. The assignment was checked in ServiceChannel. Giving the vendor 30 minutes to accept.')\">\n        Copy\n    </button>\n</div>\n\n<pre class=\"rounded-lg border border-gray-700 bg-gray-900 p-3\"><code>Reference {dispatch_ref} | Assigned emergency {trade} Work Order {dispatch_ref} to vendor {vendor_name}, Rank {vendor_rank}. The assignment was checked in ServiceChannel. Giving the vendor 30 minutes to accept.</code></pre>\n"
                }
            ],
            "crystalAttributes": {
