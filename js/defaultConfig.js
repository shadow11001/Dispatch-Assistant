        ...
        "DISPATCH": {
            ...
            "sopSections": [
                ...
                },
                {
                    ...
                    "content": "<div class=\"rounded border-l-4 border-red-500 bg-red-900/20 p-3 text-sm\">\n                <h4 class=\"font-bold text-red-400 mb-2\">Process Halted</h4>\n                <p>The store reports {store_answ}. Add the details and follow the SOP for closing the task.</p>\n                <div class=\"mt-4 flex items-center justify-between\">\n                    <h4 class=\"font-bold text-red-400\">Closing Note</h4>\n                    <button class=\"rounded bg-red-600 px-2 py-1 text-xs hover:bg-red-700 text-white font-bold\" onclick=\"navigator.clipboard.writeText(`Store reports {store_answ}. Checking SC before closing. Closing Oracle task as resolved.`)\">Copy</button>\n                </div>\n                <pre class=\"mt-2 rounded-lg border border-gray-700 bg-gray-900 p-3 whitespace-pre-wrap\"><code>Store reports {store_answ}. Checking SC before closing. Closing Oracle task as resolved.</code></pre>\n            </div>"
                },
                {
                    "id": "step-3-tech1",
                    "title": "Phase 3: Tech Call 1",
                    "showOnlyOnPhase": "phase-3-tech1",
                    "content": "<div class=\"rounded border-l-4 border-blue-500 bg-blue-900/20 p-3 text-sm\">\n                <h3 class=\"mb-2 font-bold text-blue-400\">Step 3 - Contact the Assigned Technician</h3>\n                <pre class=\"bg-gray-900 border border-gray-700 rounded-lg p-3 whitespace-pre-wrap\"><code>Hello, this is [Your Name] from Upstream Facility Services calling regarding emergency {trade} Work Order for Store {store_number}.\nThe affected equipment listed in ServiceChannel is {assets}.\nThis is a {priority} work order. Can you complete this work within the required SLA?</code></pre>\n                <div class=\"mt-4 flex items-center justify-between\">\n                    <h4 class=\"font-bold text-blue-400\">Call Note Template</h4>\n                    <button class=\"rounded bg-blue-600 px-2 py-1 text-xs hover:bg-blue-700 text-white font-bold\" onclick=\"navigator.clipboard.writeText(`Call 1 | Called assigned tech {tech_name} about emergency {trade} Work Order. Result: {tech1_answ}. Notes were added to Oracle and ServiceChannel.`)\">Copy</button>\n                </div>\n                <pre class=\"mt-2 rounded-lg border border-gray-700 bg-gray-900 p-3\"><code>Call 1 | Called assigned tech {tech_name} about emergency {trade} Work Order. Result: {tech1_answ}. Notes were added to Oracle and ServiceChannel.</code></pre>\n            </div>"
                },
                {
                    "id": "step-4-tech2",
                    "title": "Phase 4: Tech Call 2",
                    "showOnlyOnPhase": "phase-4-tech2",
                    "content": "<div class=\"rounded border-l-4 border-yellow-500 bg-yellow-900/20 p-3 text-sm\">\n                <h3 class=\"mb-2 font-bold text-yellow-400\">Step 4 - Second Call Attempt</h3>\n                <p>Call #1 was not answered. Waiting 5 minutes.</p>\n                <pre class=\"mt-2 bg-gray-900 border border-gray-700 rounded-lg p-3 whitespace-pre-wrap\"><code>Hello, this is [Your Name] from Upstream Facility Services. I am calling again about emergency {trade} Work Order for Store {store_number}. Can you complete this work within the required SLA?</code></pre>\n                <div class=\"mt-4 flex items-center justify-between\">\n                    <h4 class=\"font-bold text-yellow-400\">Call 2 Note Template</h4>\n                    <button class=\"rounded bg-yellow-600 px-2 py-1 text-xs hover:bg-yellow-700 text-white font-bold\" onclick=\"navigator.clipboard.writeText(`Call 2 | Called assigned tech {tech_name} about emergency {trade} Work Order. Result: {tech2_answ}. Notes were added to Oracle and ServiceChannel.`)\">Copy</button>\n                </div>\n                <pre class=\"mt-2 rounded-lg border border-gray-700 bg-gray-900 p-3\"><code>Call 2 | Called assigned tech {tech_name} about emergency {trade} Work Order. Result: {tech2_answ}. Notes were added to Oracle and ServiceChannel.</code></pre>\n            </div>"
                },
                {
                    "id": "step-5-fsm",
                    "title": "Phase 5: FS Manager Escalation",
                    "showOnlyOnPhase": "phase-5-fs",
                    "content": "<div class=\"rounded border-l-4 border-orange-500 bg-orange-900/20 p-3 text-sm\">\n                <h3 class=\"mb-2 font-bold text-orange-400\">Step 5 - Contact FS Manager</h3>\n                <pre class=\"bg-gray-900 border border-gray-700 rounded-lg p-3 whitespace-pre-wrap\"><code>Hello, this is [Your Name] calling from Upstream Facility Services regarding emergency {trade} Work Order for Store {store_number}.\nWe completed the required tech calls. We need your help with the next step for emergency coverage. The affected equipment is {assets}. Please advise.</code></pre>\n                <div class=\"mt-4 flex items-center justify-between\">\n                    <h4 class=\"font-bold text-orange-400\">FSM Note Template</h4>\n                    <button class=\"rounded bg-orange-600 px-2 py-1 text-xs hover:bg-orange-700 text-white font-bold\" onclick=\"navigator.clipboard.writeText(`Called FS Manager {fs_name} about emergency {trade} Work Order. Tech contact result: Escalated. FS Manager response: {fs_action}. Notes were added to Oracle and ServiceChannel.`)\">Copy</button>\n                </div>\n                <pre class=\"mt-2 rounded-lg border border-gray-700 bg-gray-900 p-3\"><code>Called FS Manager {fs_name} about emergency {trade} Work Order. Tech contact result: Escalated. FS Manager response: {fs_action}. Notes were added to Oracle and ServiceChannel.</code></pre>\n            </div>"
                },
                {
                    "id": "step-6-rm",
                    "title": "Phase 6: Regional Manager Escalation",
                    "showOnlyOnPhase": "phase-6-rm",
                    "content": "<div class=\"rounded border-l-4 border-red-500 bg-red-900/20 p-3 text-sm\">\n                <h3 class=\"mb-2 font-bold text-red-400\">Step 6 - Contact Regional Manager</h3>\n                <pre class=\"bg-gray-900 border border-gray-700 rounded-lg p-3 whitespace-pre-wrap\"><code>Hello, this is [Your Name] from Upstream Facility Services. I am calling about emergency {trade} Work Order for Store {store_number}. We completed the tech and FS Manager steps. We need help with the next step for emergency coverage. Please advise.</code></pre>\n                <div class=\"mt-4 flex items-center justify-between\">\n                    <h4 class=\"font-bold text-red-400\">RM Note Template</h4>\n                    <button class=\"rounded bg-red-600 px-2 py-1 text-xs hover:bg-red-700 text-white font-bold\" onclick=\"navigator.clipboard.writeText(`Called Regional Manager {rm_name} about emergency {trade} Work Order. Tech and FS Manager contact result: Escalated. RM response: {rm_action}. Notes were added to Oracle and ServiceChannel.`)\">Copy</button>\n                </div>\n                <pre class=\"mt-2 rounded-lg border border-gray-700 bg-gray-900 p-3\"><code>Called Regional Manager {rm_name} about emergency {trade} Work Order. Tech and FS Manager contact result: Escalated. RM response: {rm_action}. Notes were added to Oracle and ServiceChannel.</code></pre>\n            </div>"
                },
                {
                    "id": "step-7-vendor",
                    "title": "Phase 7: Vendor Assignment",
                    "showOnlyOnPhase": "phase-7-vendor",
                    "content": "<div class=\"rounded border-l-4 border-purple-500 bg-purple-900/20 p-3 text-sm\">\n                <h3 class=\"mb-2 font-bold text-purple-400\">Step 7 - Vendor Assignment</h3>\n                <ul class=\"mb-3 list-disc pl-5\">\n                    <li>The vendor must be on the approved list and ranked below 50.</li>\n                    <li>Do not assign Walmart HVAC or Walmart Insource.</li>\n                    <li>Give the vendor 30 minutes to accept.</li>\n                </ul>\n                <div class=\"mt-4 flex items-center justify-between\">\n                    <h4 class=\"font-bold text-purple-400\">Vendor Assignment Note</h4>\n                    <button class=\"rounded bg-purple-600 px-2 py-1 text-xs hover:bg-purple-700 text-white font-bold\" onclick=\"navigator.clipboard.writeText(`Reference {dispatch_ref} | Assigned emergency {trade} Work Order to vendor {vendor_name}, Rank {vendor_rank}. The assignment was checked in ServiceChannel. Giving the vendor 30 minutes to accept.`)\">Copy</button>\n                </div>\n                <pre class=\"mt-2 rounded-lg border border-gray-700 bg-gray-900 p-3\"><code>Reference {dispatch_ref} | Assigned emergency {trade} Work Order to vendor {vendor_name}, Rank {vendor_rank}. The assignment was checked in ServiceChannel. Giving the vendor 30 minutes to accept.</code></pre>\n            </div>"
                },
                {
                    "id": "success-accepted",
